...
func (_i *versionController) Show(c *fiber.Ctx) error {
	...
	versions, err := _i.versionService.Show(uuid.Must(uuid.Parse(id)))
	if err != nil {
		return err
	}
...
func (_i *versionController) Update(c *fiber.Ctx) error {
	...
	err := _i.versionService.Update(uuid.Must(uuid.Parse(id)), *req)
	if err != nil {
		return err
	}
...
func (_i *versionController) Delete(c *fiber.Ctx) error {
	...
	err := _i.versionService.Destroy(uuid.Must(uuid.Parse(id)))
	if err != nil {
		return err
	}
